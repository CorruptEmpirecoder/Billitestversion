...
ALIVE_LOGO = getenv("ALIVE_LOGO", "https://graph.org/file/1f1eaedadfe813d3ae0f5.jpg")
...
REPO_URL = getenv("REPO_URL", "https://github.com/CorruptEmpirecoder/billitestversion")
